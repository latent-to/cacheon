"""Immutable identities for evaluation incumbents.
...
ContributionRef: TypeAlias = ProposalContributionRef
...
def contribution_ref_from_dict(value: object) -> ContributionRef:
    ...
    raise StackManifestError("contribution requires type 'proposal'")
...
def _entry_rows(
    ...
    for index, raw in enumerate(raw_rows):
        ...
        if not isinstance(ref, ProposalContributionRef):
...
class EvaluationStackManifest:
    ...
    def __init__(
        ...
        *,
        ...
        object.__setattr__(self, "_catalog_json", catalog_json)
        object.__setattr__(self, "_entries", _entry_rows(entries))
    ...
    def with_contribution(
        ...
        *,
        ...
        if not isinstance(contribution, ProposalContributionRef):
