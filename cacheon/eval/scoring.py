...
def _evidence_digest(value: object, *, field: str) -> str:
    from cacheon.stack_identity import StackIdentityError, require_sha256_hex
    try:
...
def _validate_execution_evidence(
    ...
    *,
    ...
    from cacheon.eval.device_state import DeviceStateActiveReceipt, DeviceStateReceipt, DeviceStateSample
