...
def build_runtime_argv(
    *,
    ...
    environment = {
        ...
        "CACHEON_LAUNCH_DIGEST": launch.digest,
        "CACHEON_MODEL_CONTENT_DIGEST": launch.model_content_digest,
        "CACHEON_MODEL_MANIFEST_DIGEST": launch.model_manifest_digest,
        "CACHEON_MODEL_REVISION_DIGEST": launch.model_revision_digest,
        "CACHEON_NATIVE_ARTIFACT_PUBLICATION_DIGEST": publication.publication_digest,
        "CACHEON_NATIVE_ARTIFACT_ROOT": artifact_destination,
        "CACHEON_NATIVE_BUILD_SPEC_DIGEST": resolved.native_build_spec.digest,
        "CACHEON_PREBUILT_ARTIFACTS": "1",
        "CACHEON_REBUILD_PHASE": "load",
        "CACHEON_RUNTIME_DIGEST": launch.runtime_digest,
        "CACHEON_SESSION_PROTOCOL": session_protocol,
        "CACHEON_STACK_DIGEST": launch.stack_digest,
        "CACHEON_TARGET_GPU_ARCH": resolved.native_build_spec.target_architecture,
        "CACHEON_WORKER_DISTRIBUTION_DIGEST": launch.worker_distribution_digest,
        "CACHEON_EXPECTED_SGLANG_VERSION": preflight.sglang_version,
    ...
    argv.extend(
        (
            ...
            "-I",
            "-m",
            "cacheon.eval.oci_session_worker",
        )
    )
    return tuple(argv)
