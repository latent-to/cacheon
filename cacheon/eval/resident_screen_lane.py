...
* :meth:`~cacheon.eval.oci_backend.OCIEngineExecutor.execute_resident` owns the
...
def screen_swappability(manifest: Manifest) -> str | None:
    ...
    Mirrors the worker-side refusals in :func:`cacheon.seam.swap_resident_bundle`
