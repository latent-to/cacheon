...
The wrap is a thin shell over ``cacheon.moe_export.maybe_export``: when the ACTIVE
...
_PATCH_FLAG = "_cacheon_moe_export_patched"
_MODULE = "sglang.srt.layers.quantization.modelopt_quant"
_FUNC = "flashinfer_cutlass_fused_moe"
_ORIG_ATTR = "_cacheon_orig_flashinfer_cutlass_fused_moe"
