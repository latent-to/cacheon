...
from cacheon._strict import require_digest, require_exact_fields, require_identifier

if TYPE_CHECKING:
    from cacheon.engine_tree import MaterializedEngineTree

from cacheon.deppatch import DepPatchError, FilePatch, apply_file_patch, parse_patch_text
...
def build_discovery_overlay_stage(
    ...
    *,
    ...
    inventory reopening belong to :mod:`cacheon.eval.native_artifact`.  This
