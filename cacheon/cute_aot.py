...
from cacheon.artifact_resource_identity import (
...
from cacheon._strict import duplicate_key_pairs, require_digest
...
def deterministic_export_names(
    *,
    ...
    if artifact_target_authority_sha256 is None:
        from cacheon.manifest import static_artifact_target_authority
...
def _main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(prog="python -m cacheon.cute_aot")
