...
def _direct_artifact_projection(
    ...
    from cacheon.artifact_abi import ArtifactABIError
    from cacheon.artifact_device_launch import DeviceLaunchError
    from cacheon.artifact_provider import ARTIFACT_PROVIDERS, ArtifactBindingABI
