...
ARMED = "CACHEON_DISCOVERY_OVERLAY_ARMED"
PROCESS_ROLE = "CACHEON_DISCOVERY_PROCESS_ROLE"
ROLE_PARENT_PID = "CACHEON_DISCOVERY_ROLE_PARENT_PID"
DRIVER_PID = "CACHEON_DISCOVERY_DRIVER_PID"
OVERLAY_ROOT = "CACHEON_DISCOVERY_OVERLAY_ROOT"
EXPECTED_IDENTITY = "CACHEON_DISCOVERY_EXPECTED_IDENTITY"
ACTIVE_IDENTITY = "CACHEON_DISCOVERY_OVERLAY_ACTIVE"
ACTIVATION_FAILED = "CACHEON_DISCOVERY_OVERLAY_FAILED"
...
_TRAMPOLINE_MODULE = "cacheon.discovery_overlay"
_TRAMPOLINE_QUALNAME = "_scheduler_overlay_entry"
_SCHEDULER_ARGUMENT_SCHEMA = "cacheon.discovery-scheduler-arguments.v1"
_SCHEDULER_PICKLE_PROTOCOL = 5
_MAX_SCHEDULER_ARGUMENT_BYTES = 1 << 20
_DRIVER_MODULE = "sglang/__init__.py"
_ACTIVATION_SCHEMA = "cacheon.discovery-driver-activation.v1"
_ACTIVATION_POLICY_SCHEMA = "cacheon.discovery-activation-policy.v1"
_MAX_MEMBERS = 64
...
def install_process_role_hook() -> None:
    ...
    current = base.start
    if getattr(current, "__cacheon_discovery_role_hook__", False):
        return
    original = current
    ...
    start.__cacheon_discovery_role_hook__ = True
    start.__cacheon_original_start__ = original
    base.start = start
