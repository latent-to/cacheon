...
the per-file ignores in `pyproject.toml` list the files whose remaining
findings are deferred cleanup. Shrinking that list is cleanup; growing it is
a reviewed decision.
